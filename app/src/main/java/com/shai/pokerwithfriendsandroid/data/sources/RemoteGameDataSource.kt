...
//    suspend fun fetchGamesForTournament(tournamentId: String, lastSyncTimestamp: Long?): ApiOperation<List<LocalGame>>
    suspend fun fetchGamesForTournament(tournamentId: String, knownGameIds: List<String>): ApiOperation<List<LocalGame>>
