...
@Composable
fun TournamentList(
    paddingValues: PaddingValues, tournaments: List<LocalTournament>, onItemClick: (String) -> Unit
) {
...
@Composable
fun TournamentItem(tournament: LocalTournament, onItemClick: (String) -> Unit) {
