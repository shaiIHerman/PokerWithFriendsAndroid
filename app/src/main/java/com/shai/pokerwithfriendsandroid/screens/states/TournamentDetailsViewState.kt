...
sealed class TournamentDetailsViewState {
    ...
    data class Idle(val tournament: TournamentEntity, val games: List<RemoteGame?>) :
        TournamentDetailsViewState()

    data class InSession(val tournament: TournamentEntity, val games: List<RemoteGame?>) :
        TournamentDetailsViewState()
